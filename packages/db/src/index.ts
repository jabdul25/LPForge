...
export function liveEvidenceLeaseReleaseReason(value:{state:string;startedAt?:string|undefined;expiresAt?:string|undefined;failureCount?:number|undefined;eventPathEstimateFresh?:boolean;phase3Status?:string|undefined},observedAt:string):string|undefined{
 if(value.state!=='ACTIVE_CANDIDATE')return undefined;
 if(value.eventPathEstimateFresh)return 'LIVE_EVIDENCE_LEASE_EVENT_PATH_COMPLETE';
