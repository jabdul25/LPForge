...
export type TransactionIntentKind = 'JUPITER_SWAP'|'METEORA_OPEN'|'METEORA_POSITION_EXTEND'|'METEORA_OPEN_CHUNK'|'METEORA_ADD'|'METEORA_REMOVE'|'METEORA_CLAIM'|'METEORA_CLOSE';
