...
export function createVersionedMainnetEnvelope(transaction:VersionedTransaction):SerializableMainnetEnvelope{return{serializeMessage(){return transaction.message.serialize();},attachSignature(publicKeyAddress,signature){transaction.addSignature(new PublicKey(publicKeyAddress),signature);},serializeSigned(){return transaction.serialize();}};}
