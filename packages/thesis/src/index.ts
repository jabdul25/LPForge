...
export interface MachineReadableLpThesis {
  ...
  selectedCandidate:{id:string;strategy:string;orientation:string;lowerBinId:number;upperBinId:number;widthBins:number;capitalFraction:number};
