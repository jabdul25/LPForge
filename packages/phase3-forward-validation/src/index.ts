...
export function freezePhase3ForwardDecision(input: { recommendation: ShadowRecommendation; artifact: RuntimeArtifactProvenance; phase4?: FrozenPhase4ForwardSnapshot }): FrozenPhase3ForwardDecision {
  ...
  return copy({
    ...
    prediction: {
      ...
      rawCandidateReplayFeeValue: candidateSimulation?.rawReplayFeeValue ?? candidateExpectedFeeValue,
      calibratedCandidateFeeValue: candidateExpectedFeeValue,
      feeEvidenceCalibration: candidateSimulation?.feeEvidenceCalibration ?? null,
