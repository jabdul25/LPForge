...
test('partial-entry recovery rows feed the phase-7 hold gate and recovery facts',()=>{
  ...
  assert.ok(src.includes("state NOT IN ('RESOLVED','OPEN_RECOVERED','SUPERSEDED_BY_SUCCESSFUL_ENTRY','ABORTED_SOL_SETTLED')"),'postgres counts only unresolved partial entries');
