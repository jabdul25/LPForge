...
test("terminal assessment preserves expired no-effect evidence and accepts audited residual deduplication",async()=>{
  ...
  const assessment=assessLifecycleSettlement({...base,transactions:[{transactionId:"expired",state:"PROVEN_NOT_LANDED"}],inventoryLots:[{lotId:"duplicate",positionAddress:"p",planId:"entry",ownerAddress:"owner",poolAddress:"pool",tokenMint:"mint",tokenSide:"X",sourceEvent:"RECOVERY_RESIDUAL",rawAmount:1n,remainingRawAmount:0n,decimals:6,acquiredAt:"2026-08-29T00:00:00.000Z",status:"TRANSFERRED",payload:{terminalSettlement:{source:"P6_RECOVERED_OPEN_RESIDUAL_DEDUPLICATION",canonicalLotId:"original",rawAmount:"1"}}}]});
