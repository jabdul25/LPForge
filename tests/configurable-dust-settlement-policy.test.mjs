...
test('routine fee-claim minimum is explicit, configurable, and fails closed when malformed',()=>{
  const base={schemaVersion:1,policyId:'p',status:'ENABLED',approvalTtlMs:15000,minDevnetConfirmedRuns:1,maxActionsPerDay:1,maxOpenPositions:1,pools:[{address:'pool',maxCapitalSol:'0.03',maxOpenPositions:1}],feeClaim:{minimumClaimValueUsd:.10}};
