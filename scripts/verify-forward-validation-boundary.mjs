...
const allowed=new Set(['apps/operator/src/main.ts','apps/discovery-learning/src/main.ts','apps/discovery-learning/src/post-entry-telemetry-capture.ts','apps/discovery-learning/src/market-context-telemetry-capture.ts','apps/discovery-learning/src/inventory-forecast-v2-capture.ts','packages/db/src/index.ts','packages/post-entry-telemetry/src/index.ts','packages/market-context-telemetry/src/index.ts','packages/inventory-forecast-v2/src/index.ts']);
const offenders=[];
