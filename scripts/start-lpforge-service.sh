...
case "$service" in
  production)
    ...
    unset LPFORGE_P7_DRIFT_BASELINE_JSON LPFORGE_P7_INSTANCE_ID LPFORGE_P7_RUNTIME_ID \
      ...
      LPFORGE_P7_AUTHORITY_TTL_MS LPFORGE_P7_PLAN_DISPATCH_ENABLED \
      LPFORGE_P7_PROTECTIVE_ACTION_DISPATCH_ENABLED LPFORGE_P7_APPROVAL_ID \
  ...
  execution)
    ...
    unset NODE_ENV LPFORGE_CLUSTER SOLANA_RPC_HTTP_URL \
      ...
      LPFORGE_BOUNDED_UNATTENDED_PRODUCTION \
